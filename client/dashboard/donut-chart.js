...
// almost entirely copied from https://bl.ocks.org/mbhall88/22f91dc6c9509b709defde9dc29c63f2

module.exports = function donutChart() {
    var data = [],
        width,
        height,
        radius,
    ...
    function chart(selection) {
        selection.each(function () {
            ...
            svg.append('text')
                ...
                .attr('transform', 'translate(' + (-width / 2.25) + ') rotate(90)')
                .html(title);
            // ===========================================================================================
            ...
            function toolTip(selection) {
                ...
                selection.on('mouseenter', function (data) {
                    ...
                    svg.append('circle')
                        .attr('class', 'toolCircle')
                        .attr('r', radius * (innerRadius-0.05)) // radius of tooltip circle
            ...
            function updateLabelText(d) {
                ...
                return '<tspan>' + percentFormat(d.data[variable]) + '</tspan> &ndash; ' + d.data[category];
            }
